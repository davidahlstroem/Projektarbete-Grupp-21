<?php
  ...
  include "Include/php/database.php"
?>
...
//search function
    <?php
      if(isset($_POST['submit-search'])) {
        ...
        //Om artNo är en match skicka direkt till produkt sidan
        $sqlArtNo = "SELECT artNo FROM Product WHERE artNo='$search'";
        $resultArtNo = dBQuery($sqlArtNo);
        if(mysqli_num_rows($resultArtNo) > 0){
          $artNo = $resultArtNo->fetch_assoc()['artNo'];
          header ("Location: products.php?artNo=".$artNo);
          exit();
        }
